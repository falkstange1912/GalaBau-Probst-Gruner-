...
const CONFIG = {
  ...
  brandName: "GALABAU PROBST & GRUNER",
  brandSubtitle: "GARTEN- & LANDSCHAFTSBAU • BAUMPFLEGE • OBJEKTBETREUUNG",
  badgeText: "EXKLUSIVER DESIGN-ENTWURF",
  headlinePart1: "Gärten neu gestalten. ",
  headlinePart2: "Natur perfekt pflegen.",
  subheadline: "Ihr Fachbetrieb für anspruchsvolle Gartenplanung, Natursteinarbeiten, professionelle Baumpflege nach ZTV und zuverlässige Objektbetreuung inklusive Winterdienst. Kompetent, fachgerecht und individuell.",
...
export default function App() {
  ...
  const [applicantCount, setApplicantCount] = useState<number>(18);
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setApplicantCount((prev) => prev + (Math.random() > 0.9 ? 1 : 0));
    }, 5200);
              ...
              {[
                {
                  ...
                  title: "GaLaBau-Recruiting",
                  desc: "Facharbeiter, Landschaftsgärtner oder Azubis bewerben sich mobil in 60 Sekunden – super barrierefrei am Smartphone ohne Papierkram."
                },
                {
                  icon: <CalendarRange className="w-4 h-4 text-green-600" />,
                  title: "Digitaler Projekt-Planer",
                  desc: "Kunden übermitteln Maße, gewünschte Gewerke (Bau, Pflege, Baumdienst) und Fotos direkt online. Filtert Anfragen sofort strukturiert vor."
                }
              ].map((feat, idx) => (
                <motion.div 
                  key={idx}
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-inner border border-neutral-200/80 aspect-[4/3] bg-neutral-50 group">
                ...
                <div className="absolute bottom-3 left-3 text-white pointer-events-none">
                  ...
                  <span className="text-xs font-semibold tracking-wide">Planung • Pflege • Baumpflege</span>
                </div>
              </div>
              ...
              <div className="p-4 bg-neutral-50/80 border border-neutral-200/70 rounded-2xl flex items-center justify-between shadow-xs">
                <div className="space-y-0.5">
                  ...
                  <div className="text-xs font-bold text-neutral-800 flex items-center gap-2">
                    <span>{applicantCount} Projektanfragen aktiv</span>
            ...
            >
              <div className="space-y-4 text-center">
                ...
                <p className="text-neutral-500 text-xs leading-relaxed">
                  Dieses System befindet sich im exklusiven Demo-Modus für Probst & Gruner. Nach Freischaltung werden interaktiven Module für Pflanzenauswahl, Baummeldungen und Kurzbewerbungen voll funktionsfähig hinterlegt.
                </p>
                ...
                <div className="p-3.5 bg-neutral-50 rounded-xl border border-neutral-200 text-left font-mono text-[10px] text-neutral-500 space-y-1">
                  ...
                  <div className="text-green-700 font-bold">- Interaktive Schadens- & Sturmmeldung für den Baumdienst</div>
                  <div className="text-neutral-800 font-semibold">- Digitales Baumkataster-Schnittstellenmodul</div>
                </div>
